  ...
  return (
    <div className="p-6 space-y-6 max-w-2xl">
      <div className="space-y-2">
        ...
        <h1 className="text-2xl font-semibold">Добавить человека</h1>
      </div>

      <form action={createPerson} className="rounded border p-4 space-y-4">
        <div className="space-y-1">
          <label className="text-sm font-medium" htmlFor="fullName">ФИО</label>
          <input id="fullName" name="fullName" className="w-full rounded border px-3 py-2 text-sm" required />
        </div>

        <div className="space-y-1">
          <label className="text-sm font-medium" htmlFor="role">Должность</label>
          <select id="role" name="role" className="w-full rounded border px-3 py-2 text-sm" required defaultValue="ACTOR">
        ...
        <div className="grid grid-cols-2 gap-3">
          <div className="space-y-1">
            ...
            <input id="phone" name="phone" className="w-full rounded border px-3 py-2 text-sm" />
          </div>
          <div className="space-y-1">
            <label className="text-sm font-medium" htmlFor="email">Email (необязательно)</label>
            <input id="email" name="email" type="email" className="w-full rounded border px-3 py-2 text-sm" />
          </div>
        </div>
        ...
        <div className="flex gap-2">
          ...
          <Link className="px-4 py-2 rounded border text-sm hover:bg-neutral-50" href="/people">
            Отмена
          </Link>
        </div>
      </form>
